...
import {CardLokasi} from '../..';
import {colors, responsiveWidth} from '../../../utils';

const ListLokasi = ({
  getListLokasiLoading,
  getListLokasiResult,
  getListLokasiError,
  navigation,
}) => {
  console.log('DILISTSSSSSSSSSSSSSSSSSSSSS', getListLokasiResult);
  const Tombols = props => {
    return (
      <View>
...
const mapStateToProps = state => ({
  getListLokasiLoading: state.LokasiReducer.getListLokasiLoading,
  getListLokasiResult: state.LokasiReducer.getListLokasiResult,
  getListLokasiError: state.LokasiReducer.getListLokasiError,
});
